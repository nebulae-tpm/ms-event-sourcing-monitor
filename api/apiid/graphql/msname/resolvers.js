...
module.exports = {
    ...
    Query: {
        getHelloWorldFrommsname(root, args, context) {
            return broker
                .forwardAndGetReply$(
                    "HelloWorld",
                    "apiid.graphql.query.getHelloWorldFrommsname",
        ...
        msnameHelloWorldSubscription: {
            subscribe: withFilter(
                (payload, variables, context, info) => {
                    return pubsub.asyncIterator("msnameHelloWorldSubscription");
                },
                (payload, variables, context, info) => {
                    return true;
                }
...
const eventDescriptors = [
    {
        backendEventName: 'msnameHelloWorldEvent',
        gqlSubscriptionName: 'msnameHelloWorldSubscription',
